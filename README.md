...
- **3220 unit tests**: Current development-tree suite using `node:test` across 128 test files (published v1.5.1 baseline: 2858 tests across 108 files)
...
A `node:test` based test suite (3220 tests across 128 files in the current development tree; 2858 tests across 108 files in the published v1.5.1 baseline) covers the core hook libraries. To run:
