...
export const DEFAULT_ROUTING_CONFIG = {
  ...
  routes: {
    ...
    'deep-mutation':      { agent: 'agent-olympus:hephaestus', model: 'sonnet', fallbackChain: ['sonnet', 'opus'], teamWorkerType: 'codex' },
    'quick':              { agent: 'agent-olympus:executor', model: 'sonnet', fallbackChain: ['sonnet', 'haiku'], teamWorkerType: null },
    ...
    'external-model':     { agent: 'agent-olympus:ask', model: 'sonnet', fallbackChain: ['sonnet'], teamWorkerType: null },
