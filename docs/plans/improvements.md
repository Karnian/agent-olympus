...
### E4. Per-Agent Snapshot — 📋 Backlog

- **계획**: `.ao/state/agent-snapshots/<agent>-<run-id>.json`

### E5. AC Verification Framework — 📋 Backlog

- **계획**: Acceptance Criteria 자동 검증 프레임워크
...
### E7. Session Replay — 📋 Backlog

- **계획**: Run artifacts 기반 실행 재생

### E8. TaskUpdate Events — 📋 Backlog

- **계획**: 워커 진행률 실시간 이벤트 스트림

### E9. Next-Step Suggestions — 📋 Backlog

- **계획**: 실행 완료 후 다음 액션 자동 제안
