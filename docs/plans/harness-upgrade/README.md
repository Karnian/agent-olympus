...
- Shipping now honors revocable no-ship follow-ups, binds release operations to
  repository/base/branch/SHA identity, and aggregates all CI workflows for the
  exact pushed commit with crash-safe bounded fix recovery.
